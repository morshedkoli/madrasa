...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-[#1B6B3A] text-white shadow hover:bg-[#155a30]",
        destructive: "bg-red-500 text-white shadow hover:bg-red-600",
        outline: "border border-[#1B6B3A]/20 bg-white text-[#1B6B3A] hover:bg-[#FAF7F0]",
        secondary: "bg-[#C9A84C] text-white shadow hover:bg-[#b8973a]",
        ghost: "hover:bg-gray-100 hover:text-gray-900",
        link: "text-[#1B6B3A] underline-offset-4 hover:underline",
      },
      size: {
